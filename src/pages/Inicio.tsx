...
export default function Inicio() {
	...
	const heroImages = [frontImage, frontImage2, frontImage3];
	...
	const accesosRapidos = [
		{
			...
			descripcion: 'Malla curricular actualizada por ciclos.',
			icono: BookOpen,
			link: '/academico/malla-curricular',
			imagen:
				'https://images.unsplash.com/photo-1522202176988-66273c2fd55f?w=600&q=80',
		},
		{
			titulo: 'Plana Docente',
			descripcion: 'Profesores e investigadores comprometidos.',
			icono: Users,
			link: '/organizacion/docentes',
			imagen:
				'https://images.unsplash.com/photo-1524178232363-1fb2b075b655?w=600&q=80',
		},
		{
			titulo: 'Investigación',
			descripcion: 'Líneas, proyectos y publicaciones activas.',
			icono: FlaskConical,
		...
		},
		{
			...
			descripcion: 'Pasos y requisitos para tu titulación.',
			icono: GraduationCap,
			link: '/academico/titulacion',
			imagen:
				'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=600&q=80',
		},
		{
			titulo: 'Convenios',
			descripcion: 'Alianzas con entidades del sector ambiental.',
			icono: Handshake,
	...
	const cifras = [
		{
			numero: '+15',
			etiqueta: 'Años formando ingenieros',
			sub: 'de trayectoria ininterrumpida',
		},
		{
			numero: '800+',
			etiqueta: 'Egresados a nivel nacional',
			sub: 'aportando a la sostenibilidad',
		},
		{
			numero: '100%',
			etiqueta: 'Malla actualizada',
			sub: 'con enfoque en sostenibilidad',
		},
		{
			numero: 'SINEACE',
			etiqueta: 'En proceso de acreditación',
			sub: 'calidad educativa',
		},
	];
          ...
          ══════════════════════════════════════════ */}
            ...
            el contenido del hero se queda fijo encima. */}
				{heroImages.map((img, i) =>
					loadedImgs.has(i) ? (
						<img
							...
							className='absolute inset-0 z-0 w-full h-full object-cover transition-opacity duration-[1500ms] ease-in-out [will-change:opacity]'
				...
				<div
					...
					style={{
						background:
							'linear-gradient(110deg, rgba(0,0,0,0.05) 0%, rgba(0,29,70,0.62) 42%, rgba(0,20,55,0.77) 70%, rgba(0,18,50,0.80) 100%)',
					}}
				/>

				{/* Patrón de puntos sutil */}
				<svg
					className='absolute inset-0 w-full h-full z-[2] opacity-[0.04]'
				...
				<div className='container relative z-10 mx-auto px-4 md:px-8 pt-10 pb-10 lg:pt-12 lg:pb-14'>
					...
					>
						<motion.p
							...
							className='text-base md:text-lg font-display font-semibold text-white/70 uppercase tracking-widest mb-1'
						>
						...
						>
							[Nombre
							<br />
							<span className='text-gold'>de la Escuela]</span>
						</motion.h1>
						...
						>
							Formamos [profesionales de la especialidad] en la Universidad Nacional de
							Trujillo, con rigor científico y compromiso con el desarrollo.
						</motion.p>
						...
						>
							<Link to='/academico/malla-curricular'>
								<motion.button
									whileHover={{
										scale: 1.04,
										boxShadow: '0 0 32px rgba(230,172,9,0.5)',
									}}
									whileTap={{ scale: 0.97 }}
							...
							<Link to='/nosotros/mision-vision'>
								<motion.button
									...
									whileTap={{ scale: 0.97 }}
									className='w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-white/15 hover:bg-white/25 border border-white/30 text-white font-bold px-8 py-3.5 rounded-xl text-base transition-colors'
								>
									Conoce la Escuela
					...
					<div className='grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
						...
						>
							...
							<div className='text-gray-700 font-body space-y-4 leading-relaxed'>
								<p>
									"Bienvenidos a la Escuela Profesional de [Nombre de la Escuela].
									Formamos [profesionales de la especialidad] capaces de resolver problemas complejos
									de su disciplina con rigor científico y compromiso con la
									excelencia. Te invitamos a conocer un programa que cuida
									cada detalle de tu formación."
								</p>
								<footer className='text-sm text-gray-600 not-italic font-semibold'>
									[Nombre de la Autoridad], Rector(a) de la Universidad Nacional de
									Trujillo
								</footer>
							</div>
						</motion.div>
						...
						>
							<iframe
								...
								title='Video Institucional [Nombre de la Escuela] UNT'
								frameBorder='0'
								loading='lazy'
				...
				<div className='container mx-auto px-4 md:px-8'>
					<div className='flex flex-col sm:flex-row sm:items-end justify-between mb-10 gap-4'>
						<SectionTitle
							...
							subtitle='Últimas novedades, eventos y comunicados de la Escuela.'
						/>
						<Link
							to='/noticias'
							...
							return (
								...
								>
									<Link to={acceso.link} className='block h-full group'>
										<div className='h-full rounded-2xl overflow-hidden bg-white border border-gray-100 hover:border-gold/40 transition-[color,border-color,box-shadow] duration-300 hover:shadow-[0_12px_40px_rgba(230,172,9,0.15)] flex flex-col'>
											{/* Imagen de Portada */}
											<div className='h-32 w-full relative overflow-hidden shrink-0'>
												<div className='absolute inset-0 bg-primary/50 z-10 group-hover:bg-primary/30 transition-colors duration-500' />
												<img
													src={acceso.imagen}
													alt={acceso.titulo}
													loading='lazy'
				...
				<div className='container mx-auto px-4 md:px-8'>
					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8 mt-12'>
						...
						<motion.div
							...
							className='group relative rounded-3xl overflow-hidden bg-blue-deep h-[380px] md:h-[450px] flex items-end shadow-xl transform-gpu'
						>
							<div className='absolute inset-0'>
								<img
									...
									loading='lazy'
									decoding='async'
									className='w-full h-full object-cover group-hover:scale-105 transition-transform duration-1000 opacity-40'
								/>
							...
							<div className='relative z-10 p-8 md:p-10 w-full transform group-hover:-translate-y-2 transition-transform duration-500'>
								...
								<p className='text-white/80 text-sm md:text-base leading-relaxed max-w-lg'>
									Descripción del ambiente, infraestructura o equipamiento del
									laboratorio principal, donde los estudiantes desarrollan las
						...
						>
							...
							<div className='relative z-10 p-8 md:p-10 w-full transform group-hover:-translate-y-2 transition-transform duration-500'>
								...
								<div className='w-24 h-1 bg-gold mb-4 origin-left scale-x-50 transition-transform duration-500 group-hover:scale-x-100'></div>
								<p className='text-white/80 text-sm md:text-base leading-relaxed max-w-lg'>
									Descripción del segundo ambiente principal, destacando el
									equipamiento disponible y las competencias prácticas que los
									estudiantes adquieren en él.
								</p>
							</div>
						</motion.div>
					</div>
