        ...
        <div className="max-w-6xl mx-auto mt-12 grid grid-cols-1 md:grid-cols-2 gap-7">
          {tramites.map((tramite, idx) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full flex flex-col bg-white rounded-2xl border border-gray-100 hover:border-gold/30 hover:shadow-[0_8px_32px_rgba(230,172,9,0.1)] transition-[border-color,box-shadow] duration-300 overflow-hidden">
                {/* Cabecera azul */}
