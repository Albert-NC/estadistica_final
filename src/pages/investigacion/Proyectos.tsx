  ...
  return (
    <div className="bg-white py-16 md:py-20">
      <div className="container mx-auto px-4 md:px-8">
        <SectionTitle title="Proyectos de **Investigación**" center subtitle="Estudios e iniciativas en curso en modelamiento estadístico, ciencia de datos e investigación cuantitativa." />
