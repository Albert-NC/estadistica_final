  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="w-12 h-12 bg-black text-white rounded-full flex items-center justify-center shadow-lg hover:scale-110 hover:shadow-xl transition-[transform,box-shadow] duration-300 relative overflow-hidden transform-gpu group"
        aria-label="TikTok"
      >
