...
export default function ValorItem({ valor, index }: ValorItemProps) {
  return (
    <motion.div
      ...
      className="group"
    >
      <div className="h-full bg-white rounded-2xl border border-gray-100 hover:border-gold/40 hover:shadow-lg transition-[color,border-color,box-shadow] duration-300 p-6 flex gap-4 items-start">
        {/* Índice numérico */}
