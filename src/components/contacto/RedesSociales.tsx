    ...
    <div className="flex gap-4 mt-6">
      {Object.entries(redesSociales).map(([red, url]) => (
        <a
          ...
          className="w-10 h-10 rounded-full bg-primary/10 text-primary flex items-center justify-center hover:bg-secondary hover:text-white transition-[color,background-color,transform,box-shadow] hover:-translate-y-1 shadow-sm hover:shadow-md"
