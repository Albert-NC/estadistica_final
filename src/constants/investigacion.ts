...
export const proyectos = [
  {
    titulo: "Modelización Econométrica Data Panel de la Inversión Extranjera Directa en el PBI en países de la Asociación Latinoamericana de Integración, 2000-2023",
    estado: "Finalizado",
    año: "2025",
    descripcion: "La presente investigación analiza el efecto de la Inversión Extranjera Directa (IED) sobre el Producto Bruto Interno (PBI) en los países que integran la Asociación Latinoamericana de Integración (ALADI), en el período comprendido entre los años 2000 y 2023. Se utilizó un enfoque cuantitativo con modelos econométricos de datos de panel.",
    investigadores: ["Milton Giancarlo Medina Ascón (Autor)", "Dra. Daphne Jannet Timaná Palacios (Asesora)"]
  },
  {
    titulo: "Un modelo de data panel de la contribución del turismo en el PBI de los países de Sudamérica",
    estado: "Finalizado",
    año: "2025",
    descripcion: "La presente investigación tuvo como finalidad analizar la contribución del turismo en el Producto Bruto Interno (PBI) de los países de Sudamérica durante el periodo 2000–2019, aplicando modelos de datos de panel: regresión agrupada, efectos fijos y efectos aleatorios.",
    investigadores: ["Marisol Alessandra García Tejeda (Autor)", "Dra. Daphne Jannet Timaná Palacios (Asesora)"]
  }
];
